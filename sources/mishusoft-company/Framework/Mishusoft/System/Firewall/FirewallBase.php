...
abstract class FirewallBase extends Base
{
     ...
     * @var array|string
     */
    protected static $messageOfBlock = "";
    /**
    ...
    protected function loadConfig(): void
    {
        ...
        if (is_readable(self::configFile()) === true) {
            ...
            Log::info(sprintf("Start of test whether the content of %s file can be converted to array format.", self::configFile()));
            ...
            Log::info(sprintf("End of test whether the content of %s file can be converted to array format.", self::configFile()));
            /*
    ...
    protected function storeFirewallLogs(): void
    {
        ...
        if (is_writable(dirname($logDataFile)) === true) {
            ...
            throw new PermissionRequiredException(sprintf("Unable to write %s", dirname($logDataFile)));
        } //end if
    }
