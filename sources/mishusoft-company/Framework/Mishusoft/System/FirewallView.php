                    ...
                    return [
                        'div' => [
                            ...
                            [
                                ...
                                'text'  => self::messageDescriptionOnly()
                            ],
                            [
                                'class' => 'application-content-body',
                    ...
                    return [
                        'section' => [
                            ['class' => 'application application-concat', 'child' => [
                                'article' => [
                                    [
                                        'class' => 'application-content-concat application-content-width-auto border-grey-300',
                                    ...
                                    [
                                        'class' => 'application-content-concat application-content-width-auto',
                                        'style' => 'padding:1.25rem 2.5rem !important;',
                                        'child' => [
                                            'div' => [
                                                ['child' => [
                                                    'div' => [
                            ...
                            ['class' => 'application application-concat', 'style' => 'margin-bottom:20px', 'child' => [
                                'article' => [
                                    ['class' => 'application-content-concat application-content-width-auto', 'child' => [
                                        'div'   => [
                                            [
...
//        if (strtolower(Http\IP::getCountry()) !== 'unknown') {
//            $visitorDetails[] = [
//                'class' => 'details-item',
//                'child' => [
//                    'td' => [
...
//                ],
//            ];
//        } elseif (strtolower(Http\IP::getInfo('country')) !== 'unknown location') {
//            $visitorDetails[] = [
//                'class' => 'details-item',
//                'child' => [
//                    'td' => [
