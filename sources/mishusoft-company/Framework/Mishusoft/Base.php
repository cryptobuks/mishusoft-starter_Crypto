...
abstract class Base extends Singleton
{
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::frameworkDataPath(), "views", DS);
    }
    ...
    {
        if ($isRemote) {
            return sprintf('%1$s%2$s', BASE_URL, "media/logos/");
        }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::usersPicturesPath(), "profiles", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::mediaPath(), "users", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::usersPicturesPath(), "covers", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::usersPicturesPath(), "backgrounds", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::storagesPath(), "databases", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::frameworkDataPath(), "caches", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::frameworkDataPath(), "logs", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%3$s', self::frameworkDataPath(), "data-drive", DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%4$s%3$s', self::frameworkDataPath(), "configs", $directive, DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%5$s%3$s%5$s%4$s', self::frameworkDataPath(), "configs", $directive, $filename, DS);
    }
    ...
    {
        return sprintf('%1$s%2$s%5$s%3$s%5$s%4$s', self::frameworkDataPath(), "logs", $directive, $filename, DS);
    }
}
