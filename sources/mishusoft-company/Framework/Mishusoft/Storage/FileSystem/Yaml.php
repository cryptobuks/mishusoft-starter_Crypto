...
class Yaml
{
     ...
     * @throws Exception
     */
    public static function emitDallGoot($input, int $options = null): string
    {
     ...
     */
    public static function emitFile(string $filename, $data, int $encoding = YAML_ANY_ENCODING, int $linebreak = YAML_ANY_BREAK, array $callbacks = []): bool
    {
        self::validation();
        return yaml_emit_file($filename, $data, $encoding, $linebreak);
    }
     ...
     * @param mixed $data
     */
    public static function emitFileSelf(string $filename, $data): bool
    {
     ...
     * @throws RuntimeException
     */
    public static function emit($data, int $encoding = YAML_ANY_ENCODING, int $linebreak = YAML_ANY_BREAK, array $callbacks = []): string
    {
        self::validation();
     ...
     * @param mixed $data
     */
    public static function emitFileDallGoot(string $filename, $data): bool
    {
        if (!file_exists(dirname($filename))) {
            FileSystem::makeDirectory(dirname($filename));
        }
     ...
     * @return string A YAML string representing the original PHP value
     */
    public static function emitSelf($input, int $inline = 2, int $indent = 4, int $flags = 0): string
    {
     ...
     * @throws RuntimeException
     */
    public static function parse(string $input, int $pos = 0, int &$ndocs = null, array $callbacks = [])
    {
        self::validation();
     ...
     */
    public static function parseSelf(string $input, int $flags = 0)
    {
     ...
     * @return \Mishusoft\Storage\FileSystem\Dallgoot\Yaml\Yaml\YamlObject|mixed[]|null
     */
    public static function parseDallGoot(string $input)
    {
     ...
     * @throws RuntimeException
     */
    public static function parseFile(string $filename, int $pos = 0, int &$ndocs = null, array $callbacks = [])
    {
        self::validation();
     ...
     */
    public static function parseFileSelf(string $filename, int $flags = 0)
    {
        $yaml = new Yaml\Parser();
     ...
     * @return \Mishusoft\Storage\FileSystem\Dallgoot\Yaml\Yaml\YamlObject|mixed[]|null
     */
    public static function parseFileDallGoot(string $filename)
    {
     ...
     * @throws RuntimeException
     */
    public static function parseUrl(string $url, int $pos = 0, int &$ndocs = null, array $callbacks = [])
    {
        self::validation();
