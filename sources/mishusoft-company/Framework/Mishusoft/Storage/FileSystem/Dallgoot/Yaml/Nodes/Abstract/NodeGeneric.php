...
namespace Mishusoft\Storage\FileSystem\Dallgoot\Yaml\Nodes\Abstract;
...
abstract class NodeGeneric
{
    ...
    public string|bool|null $identifier;
    /** @var null|NodeGeneric */
    protected null|NodeGeneric $_parent;
    ...
    public NodeGeneric|null|NodeList $value;
    /** @var string|null */
    ...
    public function getParent(int $indent = null):NodeGeneric
    {
        if (!is_int($indent)) {
            ...
            throw new \Exception("Can't find a parent for ".get_class($this), 1);
        }
    ...
    {
        $cursor = $this;
        while ($cursor->value instanceof self) {
            $cursor = $cursor->value;
        }
        return $cursor;
    }
    ...
    public function getTargetOnLessIndent(NodeGeneric &$node):NodeGeneric
    {
        ...
        if ($node instanceof Item && $supposedParent instanceof Root && $supposedParent->value->has('Key')) {
     ...
     */
    abstract public function build(&$parent = null): mixed;
