<?php
    ...
    class System extends System\Base
    {
        ...
        private static function initializeSecurity(string $status = 'Installing'): void
        {
            $data = [
                ...
                'client' => [
                    'IP'      => IP::get(),
                    'OS'      => get_http_browser_device(),
                    'browser' => get_http_browser_name_full(),
                ],
            ];

            self::verifySecurityFile(encode_to_json($data));
        ...
        private static function verifySecurityFile(string $data): void
        {
            if (file_exists(self::getRequiresFile('SECURITY_FILE_PATH')) === true
                ...
                && file_get_contents(self::getRequiresFile('SECURITY_BACKUP_FILE_PATH')) !== ''
            ) {
                FileSystem::copy(
