...
class ImplementBackup
{
        ...
        switch (gettype($content)) {
            ...
            case "array":
                ...
                if (is_array($content) && count($content) && array_keys($content) !== range(0, sizeof($content) - 1)) {
                    $properties = array_map([__CLASS__, "keyValue"], array_keys($content), array_values($content));
            ...
            case "object":
                ...
                $properties = array_map([__CLASS__, "keyValue"], array_keys($vars), array_values($vars));
     ...
     * @access   public
     */
    public static function jsonDecode(string $str, int $type = IMPLEMENT_JSON_IN_OBJ): float|bool|array|string|\stdClass|null
    {
