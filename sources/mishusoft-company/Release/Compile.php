<?php
    ...
    class Compile extends FileSystem
    {
         ...
         * @param bool   $flash   Boolean command fetching.
         *
         * @throws \Mishusoft\Exceptions\RuntimeException
         */
            ...
            if (is_file($sources) === true) {
                ...
                foreach ($files as $file) {
                    if (basename($output) !== basename($file)) {
                        $target = $output . DS . basename($file);
                    } else {
                        $target = $output;
                    }//end if
        ...
        {
            // Whitespaces left and right from these signs can be ignored.
            static $IW = [
                T_CONCAT_EQUAL,
                // .=
                T_DOUBLE_ARROW,
            ...
            if ((is_file($source) === true) && !$source = file_get_contents($source)) {
                return false;
            }//end if
