...
if (array_key_exists("tab", $_GET)) {
    ...
    if (_Array::value($_GET, "tab") === "basic") {
        ...
        if (count($basicOfUser)>0) {
            ...
            $viewBoard = Ui::element(Ui::element(Ui::element($profileContent, 'basic', ['class' => 'messageZone', 'style' => Ui::css['display-flex'].'width: inherit;']), 'info', ['class' => "box-message box-success box-shadow-light"]), 'content', ['class' => 'notify-md-content']);
