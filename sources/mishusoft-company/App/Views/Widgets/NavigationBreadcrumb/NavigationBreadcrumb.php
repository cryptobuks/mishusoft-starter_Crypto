...
Ui::element(
    Ui::element($breadcrumb, "a", ["style" => $commonStyleStringForLinks, 'href' => Memory::Data("framework")->host->url]),
    "img",
    ['src' => FRAMEWORK_FAVICON_FILE, 'alt' => 'mishusoft', 'style' => 'margin: 5px;text-align: center;width: 20px;height: 20px;float: left;border-radius: 50%;box-shadow: 0 2px 4px rgba(0,0,0,.12),0 2px 4px rgba(0,0,0,.24);transition: all .15s ease;']
);
