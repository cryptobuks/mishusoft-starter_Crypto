...
let Mishusoft = angular.module('Mishusoft', []);

Mishusoft.directive('fileModel', [
    '$parse',
    function ($parse) {
        return {
            restrict: 'A',
...
Mishusoft.directive('myCurrentTime', [
    '$interval',
    'dateFilter',
...
Mishusoft.controller('ExampleController', [
    '$scope',
    function ($scope) {
...
Mishusoft.controller('MishusoftDataController', ['$scope', '$location', '$http', '$interval',
