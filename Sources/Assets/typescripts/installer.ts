...
import {sendMessage} from "./common/app-required";
import {captureElement} from "./common/app-common-required";


const UrlForInstallation = __appHostedServerRoot + "install";
...
class MishusoftInstaller {
    static init = (): void => {
        window.addEventListener('load', () => {
            ...
            captureElement('#app-installer').addEventListener('click', function () {
                sendMessage(MishusoftInstaller, {
                    security_code: 1,
    ...
    static appInstallerBaseUI = (): void => {
        ...
        //Application's title
        captureElement('#app-title').textContent = app.default.text.welcome;

        //Application's Favicon
        app.content.file.default.link.forEach(function (__file) {
        ...
        dv3.textContent = app.default.text.welcome;
        dv2.appendChild(dv3);
        ...
        let img2 = createElement([{
            "img": {
                ...
                "src": app.content.folder.logos + "mishusoft-logo-lite.webp"
            }
        }]);
        ...
        p1.textContent = app.default.text.description;
        dv4.appendChild(p1);
        ...
        p2.textContent = app.default.text.install_state;
        dv4.appendChild(p2);
        ...
        footer.textContent = app.default.companyName + ' © ' + (new Date()).getFullYear() ;
     ...
     * */
    static appRuntimeEventManager = (message: any): void => {
            ...
            if (message.env.installation.client.base !== undefined) {
                ...
                if (message.env.installation.client.base.area === 'database-create') {
                    ...
                    if (captureElement('#app-database-create-initialize') !== null) {
                        MishusoftInstaller.setAppInstallerDatabaseCreateDefaultUI(captureElement('#app-install-database-create-tags'));
                ...
                if (message.env.installation.client.base.area === 'database') {
                    ...
                    if (captureElement('#app-database-initialize') !== null) {
                        MishusoftInstaller.setAppInstallerDatabaseDefaultUI(captureElement('#app-install-database-tags'));
                ...
                if (message.env.installation.client.base.area === 'account') {
                    ...
                    if (captureElement('#app-account-initialize') !== null) {
                        MishusoftInstaller.setAppInstallerAccountDefaultUI(captureElement('#app-install-account-tags'));
                ...
                if (message.env.installation.client.base.area === 'website') {
                    ...
                    if (captureElement('#app-website-initialize') !== null) {
                        MishusoftInstaller.setAppInstallerWebsiteDefaultUI(captureElement('#app-install-website-tags'));
     ...
     * */
    static setAppInstallerIcon = (parentNode: HTMLElement): void => {
        let img1 = createElement([{
            'img': {
                ...
                'class': 'logo-xs',
                'width': '25px',
                'src': app.content.folder.logos + 'mishusoft-logo-outline.webp'
            }
        }]);
     ...
     * @param parentNode Valid HTML element
     * */
    static setRuntimeEventMessageZone: (parentNode: HTMLElement) => void = (parentNode: HTMLElement) => {
    ...
    /**
     * @param parentNode valid HTML Element*/
    static setAppInstallerDBMSSelectionUI: (parentNode: HTMLElement) => void = (parentNode: HTMLElement) => {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerDatabaseCreateBaseUI = (parentNode: HTMLElement) => {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerDatabaseCreateDefaultUI: (parentNode: HTMLElement) => void = (parentNode: HTMLElement) => {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerDatabaseBaseUI = (parentNode: HTMLElement): void => {
        let frm1 = createElement([{
            'form': {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerDatabaseDefaultUI = (parentNode: HTMLElement): void => {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerAccountBaseUI = (parentNode: HTMLElement): void => {
        let frm1 = createElement([{
            'form': {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerAccountDefaultUI = (parentNode: HTMLElement): void => {
        let tr1 = createElement([{'tr': {}}]);
        let tr1td1 = createElement([{
            'td': {
                'class': 'col-md-4 col-sm-4 col-xs-4 col-xs-plus-4'
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerWebsiteBaseUI = (parentNode: HTMLElement): void => {
        let frm1 = createElement([{
            'form': {
     ...
     * @param parentNode Valid HTML element
     * */
    static setAppInstallerWebsiteDefaultUI = (parentNode: HTMLElement): void => {
        let tr1 = createElement([{'tr': {}}]);
        let tr1td1 = createElement([{
            'td': {
                'class': 'col-md-4 col-sm-4 col-xs-4 col-xs-plus-4'
