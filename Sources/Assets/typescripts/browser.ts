...
export class Browser {
    ...
    private browserNameFull: string = 'Unknown';
    private browserVersion: string = 'Unknown';
    private browserVersionFull: string = 'Unknown';
    private browserArchitecture: string = 'Unknown';
    private browserAppName: string = 'Unknown';
    private browserAppNameFull: string = 'Unknown';
    private browserAppVersion: string = 'Unknown';
    private browserAppCodeName: string = 'Unknown';
    private browserAppCodeVersion: string = 'Unknown';

    private browserEngineName: string = 'Unknown';
    private browserEngineNameFull: string = 'Unknown';
    private browserEngineVersion: string = 'Unknown';
    private browserInfoAll: any = [];

    private deviceName: string = 'Unknown';
    private deviceType: string = 'Unknown';
    private deviceArchitecture: string = 'Unknown';
    private deviceWindowManager: string = 'Unknown';

    private deviceInfoAll: any;
    private deviceNameFull: string;

    private deviceNameOriginal: string = 'Unknown';
    private deviceWmNameOriginal: string = 'Unknown';

    private currentDeviceInfo: any;

    /*url info*/
    private URLProtocol: string = window.location.protocol;
    private URLHostname: string = window.location.hostname;
    private URLPath: string = window.location.pathname;
    private URLPathFull: string = window.location.href;

    /*device screen info*/
    private DeviceScreenWidth: number = window.screen.width;
    private DeviceScreenHeight: number = window.screen.height;
    private DeviceScreenColorDepth: number = window.screen.colorDepth;
    private DeviceScreenPixelDepth: number = window.screen.pixelDepth;
    ...
    private analyze() {
        ...
        if (Array.isArray(self.webBrowserAppCodeNameList)) {
            self.webBrowserAppCodeNameList.forEach((value: any) => {
     ...
     * @return number
     */
    gerDeviceScreenColorDepth(): number {
     ...
     * @return number
     */
    gerDeviceScreenPixelDepth(): number {
     ...
     * @return string
     */
    getDeviceWmNameOriginal(): string {
     ...
     * @return string
     */
    getBrowserEngineNameFull(): string {
     ...
     * @return string
     */
    getBrowserAppCodeVersion(): string {
     ...
     * @return string
     */
    getBrowserAppCodeNameFull():string {
        return (this.browserAppName).trim();
    }
     ...
     * @return string
     */
    getBrowserEngineVersion(): string {
     ...
     * @return string
     */
    getDeviceWindowManager(): string {
        return (this.deviceWindowManager).trim();
    }


    gtDeviceDetails(resources: any) {
