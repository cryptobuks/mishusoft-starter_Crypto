...
Ui::elementList(Ui::element($left, 'div'), ["img" => [
    ["src" => Storage::getMediaPath("images/mail-contact.png", "remote"),"height"=>"15px","width"=>"15px", "alt" => Memory::Data()->company->mail],
], "a" => [
...
/*cell phone*/
Ui::elementList(Ui::element($left, 'div'), ["img" => [
    ["src" => Storage::getMediaPath("images/ringing-phone.png", "remote"),"height"=>"15px","width"=>"15px", "alt" => Memory::Data()->company->care],
], "a" => [
...
/*map marker*/
Ui::elementList(Ui::element($left, 'div'), ["img" => [
    ["src" => Storage::getMediaPath("images/map-marker.png", "remote"),"height"=>"15px","width"=>"15px", "alt" => Memory::Data()->company->address],
], "a" => [
...
Ui::element(
    ...
    "img", ["src" => Storage::getMediaPath("images/facebook-new.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "facebook"]
);
/*github*/
Ui::element(
    Ui::element($socialMediaBar, "a", ["class" => "protect box-shadow1", "href" => "https://github.com/mrabirahamed", "target" => "_blank", "rel" => "noreferrer"]),
    "img", ["src" => Storage::getMediaPath("images/github.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "github"]
);
...
Ui::element(
    ...
    "img", ["src" => Storage::getMediaPath("images/instagram-new.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "instagram"]
);
/*linkedin*/
Ui::element(
    ...
    "img", ["src" => Storage::getMediaPath("images/linkedin.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "linkedin"]
);
/*pinterest*/
Ui::element(
    ...
    "img", ["src" => Storage::getMediaPath("images/pinterest.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "pinterest"]
);
/*reddit*/
Ui::element(
    ...
    "img", ["src" => Storage::getMediaPath("images/reddit.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "reddit"]
);
/*tiktok*/
Ui::element(
    ...
    "img", ["src" => Storage::getMediaPath("images/tiktok.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "tiktok"]
);
/*twitter*/
Ui::element(
    Ui::element($socialMediaBar, "a", ["class" => "protect box-shadow1", "href" => "https://twitter.com/mrabir_ahamed", "target" => "_blank", "rel" => "noreferrer"]),
    "img", ["src" => Storage::getMediaPath("images/twitter.png", "remote"),"height"=>"20px","width"=>"20px", "alt" => "twitter"]
);
