<div class="flex-column row col-lg-12 col-md-12">
    <fieldset class="box-shadow box-shadow-light">
        <legend class="box-shadow box-shadow-light" style="text-transform: uppercase"><span class="font-weight-bold font-size-20">Photo Albums</span></legend>
