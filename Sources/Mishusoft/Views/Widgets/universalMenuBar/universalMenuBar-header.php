...
$authenticate = array("account","user", "developer", "consumer", "staff");
...
if (Session::get("auth")) {
    if (in_array(_String::lower($this->request["controller"]), $authenticate)) {
        ...
        Ui::elementList(Ui::element($template_header, 'nav', ['class'=>'nav-right width-70percent']), [
            "a" => [
                ["class" => "protect", "href" => Runtime::link("account/profile?a=" . time() . "&t=view&sc=" . _Array::value((array)Session::get("me"), "code") . "&tab=summery"), "text" => $translation->translate("Profile")],
                ["class" => "protect", "href" => Runtime::link("account/logout"), "text" => $translation->translate("Logout")],
            ]]);
    } else {
        Ui::elementList(Ui::element($template_header, 'nav', ['class'=>'nav-left width-50percent']), [
            "a" => [
                ["class" => "protect", "href" => Runtime::link("default_home"), "text" => $translation->translate("Home")],
                ["class" => "protect", "href" => Runtime::link("company"), "text" => $translation->translate("Company")],
                ["class" => "protect", "href" => Runtime::link("products"), "text" => $translation->translate("Products")],
                /*["class" => "protect", "href" => Runtime::link("products/pricing"), "text" => $translation->translate("Pricing")],*/
                ["class" => "protect", "href" => Runtime::link("appointment"), "text" => $translation->translate("Career")],
                ["class" => "protect", "href" => Runtime::link("company/contact-us"), "text" => $translation->translate("Contact US")],
                ["class" => "protect", "href" => Runtime::link("support"), "text" => $translation->translate("Help")]
            ]]);

        Ui::elementList(Ui::element($template_header, 'nav', ['class'=>'nav-right width-20percent']), [
            "a" => [
                ["class" => "protect", "href" => Runtime::link("account/profile?a=" . time() . "&t=view&sc=" . _Array::value((array)Session::get("me"), "code") . "&tab=summery"), "text" => $translation->translate("Profile")],
                ["class" => "protect", "href" => Runtime::link("account/logout"), "text" => $translation->translate("Logout")],
            ]]);
    ...
    if (_String::lower($this->request["controller"]."/".$this->request["method"]) === _String::lower("account/index")) {
        Ui::elementList(Ui::element($template_header, 'nav', ['class'=>'nav-right width-70percent']), [
            "a" => [
                ["class" => "protect", "href" => Runtime::link("default_home"), "text" => $translation->translate("Home")],
                ["class" => "protect", "href" => Runtime::link("company/about-us"), "text" => $translation->translate("About US")],
                ["class" => "protect", "href" => Runtime::link("account/why-choose-us"), "text" => $translation->translate("Why need an account?")],
                ["class" => "protect", "href" => Runtime::link("support"), "text" => $translation->translate("Help")]
            ]]);
    } else {
        Ui::elementList(Ui::element($template_header, 'nav', ['class'=>'nav-left width-50percent']), [
        ...
        Ui::elementList(Ui::element($template_header, 'nav', ['class'=>'nav-right width-20percent']), [
            "a" => [
                ["class" => "protect", "href" => Runtime::link("account"), "text" => $translation->translate("Log In / Join")],
            ]]);
    }
}