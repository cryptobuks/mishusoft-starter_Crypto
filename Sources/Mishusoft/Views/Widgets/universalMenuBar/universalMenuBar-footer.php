...
//    ]]);
    ...
    Ui::element($right, 'span', ['style' => Ui::htmlHrefStyle . 'color: inherit;font-family: Noto Sans, SolaimanLipi, Arial,serif;font-size: 18px;font-weight: bold;display: flex;justify-content: left;margin-top: 10px;margin-bottom: 10px;', 'text' => $translation->translate("Follow us")]);
...
Ui::elementList(Ui::element($footer1, "div", [/*"style" => "display: flex;align-items: center;justify-content: center;",*/ "class" => "col-lg-plus-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-xs-plus-12"]), [
        ...
        "copyright" => [
            ['text' => "Copyright © " . /*Memory::Data()->company->est . " - ".*/  Time::getCurrentYearNumber()/* text for system default signature*/],
        ],"a" => [
