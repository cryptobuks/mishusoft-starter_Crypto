...
if ($this->templateUse === 'no') {
    ...
    /*
     * We declare the default meta tags for html document
     * */
    ...
    /*
     * this step we declare the verifications code for seo engine
     * */
    ...
    /*
        Ui::elementList($this->documentHeadElement, [
        "meta" => [
            ["name" => "title", "content" => $this->TitleOfCurrentWebPage],
            ["name" => "keywords", "content" => $this->TitleOfCurrentWebPage],
            ["name" => "company", "content" => Memory::Data()->company->name],
            ["name" => "author", "content" => Memory::Data()->author->name],
            ["name" => "description", "content" => Memory::Data()->company->detailsDescription],//<meta name="description"content="This is an example of a meta description.This will often show up in search results.">
        ]
    ]);*/
    ...
    /*
        Ui::elementList($this->documentHeadElement, ["meta"=>
    ...
    * */
     ...
     *     <meta id="mishusoft-session-validity" name="mishusoft-session-validity" content="{$layoutParams.mishusoft_session_validity}"/>
     */
     ...
     * */
    Ui::element(Ui::getDocumentHeadElement(), 'script', ['data-ad-client' => 'ca-pub-7478244803438159', 'async' => '', 'src' => 'https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js']);
    ...
    // add noscript to ui
    Ui::setNoScriptText($this->documentBodyElement);
    // end of adding noscript
    // Ui::element($this->documentBodyElement,"script",["id"=>"content-loader","text"=>0]);
    /*
        add a2hs button*/
    ...
    $this->documentTemplateElement = Ui::element($this->documentBodyElement, 'article', ['class' => 'ms-app']);
    ...
    // add template body
    $this->documentTemplateBodyElement = Ui::element($this->documentTemplateElement, 'ms-app-body', [/*"style" => "height: 700px;",*/'class' => 'ms-app-body']);
    ...
    /*
        attach to compile*/
    // attachToRun($this->documentTemplateBodyElement, $title, $this->request, $this->variables);
    // add template footer
    ...
    Ui::elementList(
        ...
        [
            'script' => [
                ...
                // ["type" => "application/javascript", "async" => "async", "src" => Media::toDataUri("js_mishusoft-theme-js-framework.js", "remote")],
                // ["type" => "application/javascript", "async" => "async", "src" => Media::toDataUri("js_pwa.js", "remote")],
                [
                    'type'  => 'application/javascript',
                    'async' => 'async',
