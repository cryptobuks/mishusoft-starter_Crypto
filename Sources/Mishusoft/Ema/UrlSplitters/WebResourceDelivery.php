...
class WebResourceDelivery
{
    ...
    {
        if ($dirname === Memory::Data()->preset->directoryIndex) {
        ...
        Ui::elementList(Ui::getDocumentHeadElement(), [
                'link' => [
                    ['rel'  => 'stylesheet', 'href' => Media::getAssetsPath('css/mishusoft-theme.css', 'remote'),],
                    ['rel'  => 'stylesheet', 'href' => Media::getAssetsPath('css/app-ui-v4.css', 'remote'),],
                ],
            ]
        );
        ...
        $template_header = Ui::element($template, 'header', [
            'class' => 'header header-navigation-bar box-shadow2', 'style' => 'background:white;']
        );
        // add logo, menu section in navigation bar in header area
        $header_logo_zone = Ui::element($template_header, 'a', [
