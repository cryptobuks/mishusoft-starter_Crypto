...
$aboutInfo = Stream::read(PHP_RUNTIME_REGISTRIES_PATH . "company-about.json");
...
Ui::elementList(Ui::element($titleOfAbout, "span", ["style" => Ui::htmlHrefStyle . Ui::css["display-flex"] . Ui::css["flex-column"] . "margin-left: 20px;",]), ["span" => [
    ...
    ["style" => Ui::htmlHrefStyle . "font-size: 18px;font-weight: 400;", "text" => $translation->translate("Basic Information")],
]]);
