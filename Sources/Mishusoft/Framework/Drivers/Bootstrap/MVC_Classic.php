...
class MVC_Classic
{
    public static function run(ClientRequest $prediction)
    {
        ...
        if (!empty($module)) {
            ...
            if (file_exists($rootModule) && is_readable($rootModule)) {
                ...
                Firewall::runtimeFailure("Not Found", [
                    "debug" => ["file" => $module, "location" => dirname($rootModule), "description" => "The controller of your request url is not found!!"],
