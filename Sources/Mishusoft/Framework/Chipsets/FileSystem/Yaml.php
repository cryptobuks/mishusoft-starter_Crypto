...
namespace Mishusoft\Framework\Chipsets\FileSystem;
...
class Yaml
{
     ...
     * @throws RuntimeException
     */
    public static function parse(string $input, int $pos = 0, int &$ndocs = null, array $callbacks = array()): mixed
    {
        self::validation();
     ...
     * @throws RuntimeException
     */
    public static function parseFile(string $filename, int $pos = 0, int &$ndocs = null, array $callbacks = array()): mixed
    {
        self::validation();
     ...
     * @throws RuntimeException
     */
    public static function parseUrl(string $url, int $pos = 0, int &$ndocs = null, array $callbacks = array()): mixed
    {
        self::validation();
