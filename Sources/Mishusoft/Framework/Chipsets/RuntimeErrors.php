...
class RuntimeErrors extends Exception
{
    ...
    public function __construct(string $message = "", int $code = 0, int $severity = 1, string $filename = __FILE__, int $lineno = __LINE__, string $trace = "")
    {
        ...
        echo $this->codeAsString($this->getCode()) . " [$this->code] : $this->message from $this->file on line $this->line.";
    ...
    $errortype = array (
        ...
        switch ($code) {
            ...
            case 4096:
                ...
                break;
            case 8192:
                $errType = 'Identification';
                break;
            case 16384:
                $errType = 'User Identification';
                break;
            default:
                $errType = 'Unexpected Error';
                break;
        }
        return $errType;
    }
     ...
     * @param $trace
     */
    private function beautifyCallStack(string $trace)
    {
