...
/!* global MishusoftSessionValidity *!/
class MishusoftAi  {
    constructor() {
        super();
        /!*@typescripts-ignore*!/
    ...
    viewVisitorsAccessLogs() {
        ...
        ajax.open('POST', ServerRoot + 'api/getVisitorsAccessLogs', true);
    ...
    verifyUSER_AUTH() {
        ...
        xhr.open("POST", ServerRoot + 'user/verifyUserAuth', true);
            ...
            if (this.readyState === 4 && this.status === 200) {
                if (Mishusoft.IsJsonString(this.responseText)) {
                    ...
                    if (data.type === 'success' && data.message === 'LOGGED_IN') {
                        if (data.url !== '/') {
                            window.location.replace(ServerRoot + data.url);
                        } else {
    ...
    saveBranch() {
        ...
        ajaxSR.open("POST", ServerRoot + 'system/branches/addBranch', true);
    ...
    viewMainItemsTabs() {
        let ajax = new XMLHttpRequest();
        ajax.open('POST', ServerRoot + 'system/index/getMainItemTabs', true);
        ajax.setRequestHeader("Access-Control-Allow-Origin", "*");
        //receiving response from ajax
        ajax.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                if (Mishusoft.IsJsonString(this.responseText)) {
                    ...
                    if (data.length !== 0) {
                        ...
                        for (let a = 0; a < data.length; a++) {
                            ...
                            //appending at html
                            html += '<a href="' + ServerRoot + 'system/' + url + '" class="thumbnail-md box-shadow-light" title="' + title + '">';
    ...
    viewExtraItemsTabs() {
        let ajax = new XMLHttpRequest();
        ajax.open('POST', ServerRoot + 'system/index/getExtraItemTabs', true);
        ajax.setRequestHeader("Access-Control-Allow-Origin", "*");
        //receiving response from ajax
        ajax.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
    ...
    saveMenu() {
        ...
        let ajax = new XMLHttpRequest();
        ajax.open("POST", ServerRoot + 'system/menus/addMenu', true);
    ...
    savePermission() {
        ...
        let ajax = new XMLHttpRequest();
        ajax.open("POST", ServerRoot + 'system/permissions/addPermission', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajax.send(JSON.stringify(params)); // Make sure to stringify
        //receiving response from ajax
        ajax.onreadystatechange = function () {
    ...
    saveRole() {
        ...
        let ajaxSR = new XMLHttpRequest();
        ajaxSR.open("POST", ServerRoot + 'system/roles/addRole', true);
        ajaxSR.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajaxSR.send(JSON.stringify(params)); // Make sure to stringify
        //receiving response from ajax
        ajaxSR.onreadystatechange = function () {
    ...
    updateRolePermission() {
        ...
        let ajax = new XMLHttpRequest();
        ajax.open("POST", ServerRoot + 'system/roles/updateRolePermission', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
    ...
    verifyIsUserAlreadyExists() {
        ...
        ajaxB.open("POST", ServerRoot + 'system/users/isUserCreatedCheckedByUserId', true);
                    ...
                    if (dataC.length !== 0) {
                        ...
                        for (let a = 0; a < dataC.length; a++) {
                            ...
                            if (status === 'yes') {
                                ...
                                self.UploadWindowView('Upload profile picture');
                            }
                        }
                    }
                } else {
    ...
    saveUser() {
        ...
        let ajax = new XMLHttpRequest();
        ajax.open("POST", ServerRoot + 'system/users/addUser', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajax.send(JSON.stringify(data)); // Make sure to stringify
        //receiving response from ajax
        ajax.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                Mishusoft.showMessage(this.responseText, Mishusoft.detectElementById("message2"), function (data: { length: number; user: any; }) {
    ...
    deleteUser() {
        ...
        let ajax = new XMLHttpRequest();
        ajax.open('POST', ServerRoot + 'system/users/deleteUser', true);
        ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        ajax.send(JSON.stringify(params)); // Make sure to stringify
        //receiving response from ajax
        ajax.onreadystatechange = function () {
...
$('#userNotificationsAll').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'notificationsAll');
});
...
$('#registrationForm').on('keyup', '#email', function () {
    let RequestURL = ServerRoot + "user/checkValidEmailAddress";
...
$('#branch-data-table').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'branch-data-table');
});
$('#busers-data-table').on('click', '.page', function () {
    let url = 'system/branches/usersPaginationAJAX';
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'busers-data-table');
});
...
$(document).on('keyup', '#branchName', function () {
    ...
    let checkBranchNameInputAbilityURL = ServerRoot + "system/branches/checkBranchNameInputAbility";
...
$(document).on('click', '#branch-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", ServerRoot + 'system/branches/deleteBranch', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
...
$(document).on('click', '#transferBranchStuff', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Change') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", ServerRoot + 'system/branches/transferBranchStuff', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
...
$('#menus-data-table').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'menus-data-table');
});
//hide edit pad by default
...
$(document).on('keyup', '#menuTitle', function () {
    ...
    let checkMenuTitleInputAbilityURL = ServerRoot + "system/menus/checkMenuTitleInputAbility";
...
$(document).on('click', '#menu-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", ServerRoot + 'system/menus/deleteMenu', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
...
$('#modules-data-table').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'modules-data-table');
});
//hide edit pad by default
...
$(document).on('click', '#module-data-btn', function () {
    ...
    let ajax = new XMLHttpRequest();
    ajax.open("POST", ServerRoot + 'system/modules/updateModule', true);
    ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
    ajax.send(JSON.stringify(params)); // Make sure to stringify
    //receiving response from ajax
    ajax.onreadystatechange = function () {
...
$(document).on('click', '#module-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", ServerRoot + 'system/modules/deleteModule', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
...
$('#permissions-data-table').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'permissions-data-table');
});
//hide edit pad by default
...
$(document).on('click', '#permission-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            let ajax = new XMLHttpRequest();
            ajax.open("POST", ServerRoot + 'system/permissions/deletePermission', true);
            ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
            ajax.send(JSON.stringify(data)); // Make sure to stringify
            //receiving response from ajax
            ajax.onreadystatechange = function () {
...
$('#roles-data-table').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'roles-data-table');
});
...
$(document).on('click', '#role-delete-btn', function () {
    ...
    $(document).on('click', '#message-done-btn', function () {
        if (commandBtn === 'Delete') {
            ...
            ajaxDR.open("POST", ServerRoot + 'system/roles/deleteRole', true);
...
$('#users-data-table').on('click', '.page', function () {
    ...
    Mishusoft.pagination(<string>$(this).attr('page'), url, 'users-data-table');
});
//hide edit pad by default
...
$(document).on('click', '#verfyUSER', function () {
    ...
    let ajax = new XMLHttpRequest();
    ajax.open('POST', ServerRoot + 'system/users/verifyUser', true);
    ajax.setRequestHeader("Content-type", "application/json;charset=UTF-8");
    ajax.send(JSON.stringify(params)); // Make sure to stringify
    //receiving response from ajax
    ajax.onreadystatechange = function () {
...
$('#userEditPAD').on('keyup', '#userUsername', function () {
    let RequestURL = ServerRoot + "user/checkValidUsername";
...
$(document).on('click', '#user-add-btn', function () {
    ...
    Mishusoft.detectElementById('profile_picture').src = ServerRoot + 'public/images/img_avatar3.png';
});
//select data by clicking select button
...
$(document).on('click', '#user-edit-btn', function () {
    ...
    if ($(this).attr('data-profile_picture') !== '') {
        Mishusoft.detectElementById('profile_picture').src = ServerRoot + 'system/users/viewUserCurrentProfilePicture/' + $(this).attr('data-userID') + '/' + $(this).attr('data-profile_picture');
...
$(document).on('click', '#user-select-done', function () {
    ...
    if (appIDCheck === 'OK' && emailAddressCheck === 'OK') {
        ...
        let xhr = new XMLHttpRequest();
        xhr.open("POST", ServerRoot + 'payment/verifyClient', true);
        xhr.setRequestHeader("Content-type", "application/json;charset=UTF-8");
        xhr.send(JSON.stringify(params));
        xhr.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                Mishusoft.showMessage(this.responseText, Mishusoft.detectElementById("messagePanel"), function (response: { type: string; appIdEncrypt: string; emailEncrypt: string; paymentPlanTypeEncrypt: string; paymentPlanEncrypt: string; }) {
                    if (response.type === 'error' || response.type === 'success') {
                        ...
                        if (response.type === 'success') {
                            ...
                            window.location.replace(ServerRoot + 'payment/paynow/' + response.appIdEncrypt + '/' + response.emailEncrypt + '/' + response.paymentPlanTypeEncrypt + '/' + response.paymentPlanEncrypt + '/');
