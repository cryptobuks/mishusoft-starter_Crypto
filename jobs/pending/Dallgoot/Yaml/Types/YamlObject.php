<?php
namespace Mishusoft\Storage\FileSystem\Dallgoot\Yaml\Types;

use Mishusoft\Storage\FileSystem\Dallgoot\Yaml\YamlProperties;
...
class YamlObject extends \ArrayIterator implements \JsonSerializable
{
    ...
    public const UNDEFINED_METHOD = self::class.": undefined method '%s', valid methods are (addReference,getReference,getAllReferences,addComment,getComment,setText,addTag,hasDocStart,isTagged)";
    public const UNKNOWN_REFERENCE = "no reference named: '%s', known are : (%s)";
    public const UNAMED_REFERENCE  = "reference MUST have a name";
    public const TAGHANDLE_DUPLICATE = "Tag handle '%s' already declared before, handle must be unique";
